...
const TAG_NAME = "u-spy-avalanche-game";

export class AvalancheGameElement extends BaseElement {
  id: string;
  boardWidth: string = "";
  boardHeight: string = "";
  ...
  constructor() {
    ...
    this.id = `usag-${crypto.randomUUID()}`;
  }
  get usingShadow() {
    return true;
  }
...
try {
  globalThis.customElements.define(TAG_NAME, AvalancheGameElement);
} catch {}
